...
public class Procesos extends javax.swing.JFrame {
    ...
    public class RoundRobin extends Thread {
        ...
        public void run() {
            ...
            as.setText(proc_enMem[auxContP].getName());
            ...
            while (true) {
                for (int i = 0; i < cont_proc_enMem; i++) {
                    if ((this.TP == proc_enMem[i].getTL())) {
                        ...
                        as.setText(proc_enMem[i].getName());
    ...
    private void initComponents() {
        ...
        colorLayout.setHorizontalGroup(
            ...
            .addGroup(colorLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(as, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
                .addContainerGap())
        );
        colorLayout.setVerticalGroup(
            ...
            .addGroup(colorLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(as, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
                .addContainerGap())
        );
